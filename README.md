...
- [vite-vanilla-sass-lint](https://github.com/marcop135/vite-vanilla-sass-lint) - Starter template for Vanilla JS and Sass with `ESLint`, `Stylelint`, `HTMLHint`, `html-validate`, `Vitest`, and Husky.
...
- [vite-react-tailwind-lint](https://github.com/marcop135/vite-react-tailwind-lint) - Starter template for React and Tailwind CSS with `ESLint`, `Stylelint`, `HTMLHint`, `Vitest`, Testing Library, and Husky.
